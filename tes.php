                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="tes.php" method="post">
                                                    <input type="text" name="dataStorage" value="<?= $viewStorage; ?>">
                                                    <button data-index="<?= $viewStorage; ?>" type="submit" name="data" value="data" class="btn btn-outline-primary px-2 viewStorage" style="padding: 1px;">&#9664;</button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php
