...
<body>
    ...
    $queryServer = "SELECT tb_server.NO_TICKET FROM tb_server";
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php while ($result = mysqli_fetch_array($sqlReqServer)) :
                    $queryServer = "SELECT NO_TICKET FROM tb_network WHERE NO_TICKET = '$result[0]'";
                    $sqlServer = mysqli_query($conn, $queryServer);
                    ...
                    <tr class="text-white">
                        ...
                        <td style="display: flex; justify-content: space-evenly; align-items: center;">
                            ...
                            <a href="create_network.php?buat=<?= $result['NO_TICKET']; ?>" style="font-size: small;" class="btn btn-primary">CREATE</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
